...
CREATE TABLE `iscrizioni` (
  ...
  PRIMARY KEY (`idcorso`,`cf`),
  KEY `cf_idx` (`cf`),
  CONSTRAINT `cf` FOREIGN KEY (`cf`) REFERENCES `utenti` (`cf`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `idcorso` FOREIGN KEY (`idcorso`) REFERENCES `corsi` (`idcorso`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `iscrizioni` VALUES (12,'CCOMRA99P13F839X'),(14,'CCOMRA99P13F839X'),(15,'CCOMRA99P13F839X');
