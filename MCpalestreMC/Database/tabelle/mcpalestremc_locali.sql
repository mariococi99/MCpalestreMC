...
CREATE TABLE `locali` (
  ...
  `mq` int DEFAULT NULL,
  `personemax` int DEFAULT NULL,
  `idpalestra` int NOT NULL,
  PRIMARY KEY (`idlocale`),
  KEY `idpalestra_idx` (`idpalestra`),
  CONSTRAINT `idpalestra` FOREIGN KEY (`idpalestra`) REFERENCES `palestre` (`idpalestra`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `locali` VALUES (1,20,20,1),(2,30,30,1),(12,60,10,14),(13,100,15,14);
